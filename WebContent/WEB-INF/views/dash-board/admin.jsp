                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
			                       <!-- JSTL forEach loop to iterate over reviewList -->
			                       <c:forEach items="${admin}" var="admin" varStatus="status">
			                           <tr>
			                               ...
			                               <td>${admin.number}</td>
			                               <td>
			                                   <a href="<c:url value='adminDetail.htm?username=${admin.username}&curPage=${curPage}' />" >
			                                       <i class="mdi mdi-format-list-bulleted"></i>
			                                   </a>
			                               </td> <!-- Detail -->
			                               <td>
			                                   <a href="<c:url value='deleteAdmin.htm?username=${admin.username}&curPage=${curPage}' />" style="color: red;">
				  ...
				  <ul class="pagination pagination-sm">
				    ...
				    <c:forEach begin="1" end="${numPage}" var="pageNumber">
				      ...
				      <li class="page-item ${disabled}" >
				        <a class="page-link" href="review.htm?page=${pageNumber}">
				          ${pageNumber}
				        </a>
				      </li>
				    </c:forEach>
	  				<!-- button add -->
				    <li class="page-item}" >
				        <a class="page-link" href="userinfo.htm">New Admin</a>
				     </li>
				  </ul>
				</nav>
