                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
			                       <!-- JSTL forEach loop to iterate over customerList -->
			                       <c:forEach items="${customer}" var="customer" varStatus="status">
			                           <tr>
			                               ...
			                               <td>
			                                   <a href="<c:url value='../user/userinfo.htm?customerId=${customer.username}&curPage=${curPage}' />" >
				  ...
				  <ul class="pagination pagination-sm">
				    ...
				    <c:forEach begin="1" end="${numPage}" var="pageNumber">
				      ...
				      <li class="page-item ${disabled}" >
				        <a class="page-link" href="customer.htm?page=${pageNumber}">
				          ${pageNumber}
				        </a>
				      </li>
