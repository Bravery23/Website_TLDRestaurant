...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<%= request.getContextPath() %>/Resources/dashboard/assets/images/favicon.png">
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3">
                        <div class="card">
                            <div class="card-body">
                                <center class="mt-4"> <img src="<%= request.getContextPath() %>/Resources/dashboard/assets/images/users/5.jpg"
